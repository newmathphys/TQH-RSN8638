...
\subsection{Neutrino Seesaw on the Lattice}
...
The TQH/RSN-8638 framework reduces the SM free parameters to algebraic $G_2$ invariants and Riemann spectral properties. With zero fitting parameters, it reproduces masses, coupling constants, mixing angles, and cosmological observables with $\chi^2/\text{dof}=0.57$. The theory makes four falsifiable predictions: (1) a stable $G_2$-vorton dark matter particle at $568$ GeV; (2) a lightest neutrino mass $\approx0.33$ meV; (3) a stochastic gravitational wave background peaking at $\sim0.5$ mHz from the $G_2$ flop, detectable by LISA; and (4) proton decay $p\to e^+\pi^0$ with $\tau_p\sim10^{35}$ years, testable by Hyper-Kamiokande.
